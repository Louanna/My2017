...
import com.example.mymvp.activity.LoginActivity;
import com.example.mymvp.contract.LoginContract;
import com.example.gs.mvpdemo.mvp.IModel;
import com.example.gs.mvpdemo.utils.LogUtils;
import com.example.mymvp.model.LoginModel;
    ...
    public void login(String name, String pwd) {
        if (!getIView().checkNull()) {
            ((LoginModel) getiModelMap().get("login"))
                    .login(name, pwd, new LoginModel
                    .InfoHint() {
                @Override
                public void successInfo(String str) {
                    LogUtils.e("LoginPresenter.successInfo", str);
